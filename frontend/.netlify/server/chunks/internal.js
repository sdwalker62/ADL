...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\r\n<html lang="en">\r\n\r\n<head>\r\n	<meta charset="utf-8" />\r\n	<link rel="icon" href="' + assets2 + '/favicon.svg" />\r\n	<link rel="stylesheet" href="' + assets2 + '/css/stylesheet.css" />\r\n	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katex@0.16.4/dist/katex.min.css" />\r\n	<meta name="viewport" content="width=device-width" />\r\n	' + head + `\r
</head>\r
<script>\r
	document.cookie.split(';').forEach((cookie) => {\r
		cookie = cookie.trim();\r
		const cookieMap = cookie.split('=');\r
		const cookieKey = cookieMap[0];\r
		const cookieValue = cookieMap[1];\r
		if (cookieKey === 'colorMode') {\r
			document.documentElement.setAttribute('data-theme', cookieValue);\r
		}\r
	})\r
<\/script>\r
\r
<body style="margin: 0; overflow: hidden" data-sveltekit-preload-data="hover">\r
